...
export default {
  data() {
    return {
      ...
      showimage88: true, //
      showimage89: false, // initialize Pulmonary Embolism Card with a value of true
      showimage90: true, //
  ...
  methods: {
    ...
    toggleImages34() {
      this.showimage89 = !this.showimage89; // toggle the value of Pulmonary Embolism Phrase
...
<style>
  ...
  button.large8 {
   ...
   /* styles for the Pulmonary Embolism button */
   .thirty-third-button {
    position: absolute;
    top: 6440px;
    left: 5635px;
  ...
  /* styles for Pulmonary Embolism Card */
  img.image89 {
    top: 6400px;
  left: 5550px;
  position: absolute;
  ...
  /* styles for Pulmonary Embolism Button */
  img.image90 {
  top: 6400px;
  left: 5550px;
  position: absolute;
